...
from agents.transformer_backbone_plasticity import TransformerWithPlasticity
...
class DQNAgent:
    def __init__(self, state_dim, action_dim, config):
        """
        DQN Agent with Transformer backbone and plasticity injection.
        ...
        # Transformer backbone with plasticity injection
        self.model = TransformerWithPlasticity(
            state_dim=state_dim,
